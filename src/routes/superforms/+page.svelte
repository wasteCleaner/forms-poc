            ...
            {#if $eForm.region === UserRegion.EU}
                 {#if 'eu' in $eForm}
                    <div class="space-y-2">
                        ...
                        <input id="eu-vatId" name="eu.vatId" type="text" bind:value={$eForm.eu.vatId} class="border p-1 w-full rounded" />

                        <label for="eu-nationalId" class="block text-sm">National ID</label>
                        <input id="eu-nationalId" name="eu.nationalId" type="text" bind:value={$eForm.eu.nationalId} class="border p-1 w-full rounded" />
                    </div>
                 {/if}
            {:else if $eForm.region === UserRegion.US}
                 {#if 'us' in $eForm}
                    <div class="space-y-2">
                        ...
                        <input id="us-zipPlus4" name="us.zipPlus4" type="text" bind:value={$eForm.us.zipPlus4} class="border p-1 w-full rounded" />
            ...
            {:else if $eForm.region === UserRegion.UK}
                 {#if 'uk' in $eForm}
                    <div class="space-y-2">
                        ...
                        <input id="uk-postcode" name="uk.postcode" type="text" bind:value={$eForm.uk.postcode} class="border p-1 w-full rounded" />
                        ...
                        <input id="uk-county" name="uk.county" type="text" bind:value={$eForm.uk.county} class="border p-1 w-full rounded" />
                    </div>
                 {/if}
        ...
        <div class="space-y-2">
            {#each $eForm.favoriteGames as game, i}
                <div class="flex items-center gap-2 border p-2 rounded bg-gray-50">
                    ...
                    <div>
                        <input name={`favoriteGames[${i}].favoriteSince`} type="date" bind:value={game.favoriteSince} class="p-1 border rounded text-sm" placeholder="Since" />
                    </div>
                    <label class="flex items-center space-x-1">
                        <input name={`favoriteGames[${i}].pinned`} type="checkbox" bind:checked={game.pinned} />
