            ...
            <div class="flex items-center space-x-4">
                <label class="flex items-center space-x-2">
                    <input
                      ...
                      bind:checked={$eForm.contact.marketingOptIn}
                    />
                ...
                <label class="flex items-center space-x-2">
                    <input
                      type="checkbox"
                      name="contact.productUpdatesOptIn"
                    ...
                    <div class="space-y-2">
                        <label class="flex items-center space-x-2">
                            <input
                              type="checkbox"
                              name="eu.gdprConsent"
                              bind:checked={$eForm.eu.gdprConsent}
                            />
                 ...
                 {#if 'us' in $eForm}
                    <div class="space-y-2">
                        ...
                        <label class="flex items-center space-x-2 mt-2">
                            <input
                              type="checkbox"
                              name="us.taxResidencyConfirmed"
                              bind:checked={$eForm.us.taxResidencyConfirmed}
                            />
